...
state("mesen")
{
     // base address = 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08,
  	byte lineCount01 : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x50;  // 0x50;
  	byte lineCount02 : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x51;  // 0x51;
  	byte levelCount : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x0064;   // 0x0064;
  	byte score01 : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x0053;    // 0x0053;
  	byte score02 : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x0054;    // 0x0054;
  	byte score03 : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x0055;    // 0x0055; 
  	byte gameMode : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x00C0;  // 0x00C0;
  	byte gameOver : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x0400;  // 0x0400;

  	//byte gameStatus : "MesenCore.dll", 0x4311838, 0x118, 0xB8, 0x90, 0x1D8, 0x08, 0x258;  // 0x0001F0;
}
